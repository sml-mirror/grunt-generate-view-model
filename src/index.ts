...
export function GenerateView(modelName: string) {
    return function(){
        var f;
    };
}

export function IgnoreViewModel() {
    return function(){
        var f;
    };
}

export function ViewModelName(name: string) {
    return function(){
        var f;
    };
}

export function ViewModelType(type: string, filepath: string) {
    return function(){
        var f;
    };
}
